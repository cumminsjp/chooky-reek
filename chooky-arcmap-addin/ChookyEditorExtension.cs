...
{
    /// <summary>
    /// ChookyEditorExtension class implementing custom ESRI Editor Extension functionalities.
    /// </summary>
    public class ChookyEditorExtension : ESRI.ArcGIS.Desktop.AddIns.Extension
    {
        public ChookyEditorExtension()
        {
        }
        ...
        private IEditEvents_Event Events
        {
            get
            {
                return ArcMap.Editor as IEditEvents_Event;
            }
        }
        private IEditEvents2_Event Events2
        {
            get
            {
                return ArcMap.Editor as IEditEvents2_Event;
            }
        }
        private IEditEvents3_Event Events3
        {
            get
            {
                return ArcMap.Editor as IEditEvents3_Event;
            }
        }
        private IEditEvents4_Event Events4
        {
            get
            {
                return ArcMap.Editor as IEditEvents4_Event;
            }
        }
        #endregion
        ...
        void WireEditorEvents()
        {
            ...
            Events2.BeforeStopEditing += delegate(bool save)
            {
